...
export const services: ServiceItem[] = [
  {
    ...
    fullDesc:
      'Complete Zoho One implementation: CRM, Books, Inventory, Projects, HR, Finance, automation workflows, and cross-app integrations.',
...

  {
    ...
    icon: 'Calculator',
    title: 'Tally Prime',
    shortDesc: 'Accounting, inventory, GST, payroll & full configuration.',
    fullDesc: 'Implementation, data migration, customization, payroll, security setup, multi-godown & advanced reporting.',
