          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center space-x-3 group text-sm text-slate-300 hover:text-white transition-all duration-200"
              >
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all duration-200">
